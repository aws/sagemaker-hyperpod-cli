...
# class TestClusterWorkflowValidation:
#     """File validation tests for cluster workflow."""
    
#     def test_cluster_generated_cfn_params_structure(self, temp_dir, runner):
#         """Verify generated CloudFormation parameters have correct structure for cluster."""
#         # Initialize cluster template
#         result = runner.invoke(init, ["hyp-cluster", temp_dir], catch_exceptions=False)
#         assert_command_succeeded(result)
        
#         # Configure with basic parameters
#         old_cwd = os.getcwd()
#         try:
#             os.chdir(temp_dir)
#             result = runner.invoke(configure, ["--resource-name-prefix", "test-cluster"], catch_exceptions=False)
#             assert_command_succeeded(result)
...
#     def test_cluster_config_file_structure(self, temp_dir, runner):
#         """Verify config.yaml has correct structure after cluster workflow."""
#         # Initialize cluster template
#         result = runner.invoke(init, ["hyp-cluster", temp_dir], catch_exceptions=False)
#         assert_command_succeeded(result)
...
#         assert config.get('template'), "template field should be present"
#         assert config.get('resource_name_prefix'), "resource_name_prefix should be configured"