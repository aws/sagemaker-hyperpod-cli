...
class ElasticPolicy(BaseModel):
    ...
    scalingTimeout: Optional[str] = Field(
        default=None,
        alias="scaling_timeout",
        description="Timeout for scaling operations"
    )
    scalingPolicy: Optional[str] = Field(
        default=None,
        alias="scaling_policy",
        description="Scaling policy behavior (auto, aggressive, conservative)"
    )
    gracefulShutdownTimeoutSeconds: Optional[int] = Field(
        default=None,
        alias="graceful_shutdown_timeout_seconds",
        description="Graceful shutdown timeout in seconds for elastic scaling operations"
    )
    faultyScaleDownTimeoutSeconds: Optional[int] = Field(
        default=None,
        alias="faulty_scale_down_timeout_seconds",
