...
class _ClusterStackBase(BaseModel):
    ...
    instance_group_settings1: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations."
    )
    rig_settings1: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings2: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings2: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings3: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings3: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings4: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings4: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings5: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings5: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings6: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings6: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings7: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings7: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings8: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings8: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings9: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings9: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings10: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings10: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings11: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings11: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings12: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings12: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings13: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings13: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings14: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings14: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings15: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings15: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings16: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings16: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings17: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings17: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings18: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings18: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings19: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
    rig_settings19: Optional[str] = Field(
        None, 
        description="JSON array string containing restricted instance group configurations.",
        examples=["[]"]
    )
    instance_group_settings20: Optional[str] = Field(
        None, 
        description="JSON array string containing instance group configurations.",
        examples=["[]"]
    )
