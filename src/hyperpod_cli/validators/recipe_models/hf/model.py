...
class TrainerConfig(BaseModel):
    ...
    log_every_n_steps: Optional[int|str] = None
    ...
    limit_test_batches: Optional[int|str] = None
    accumulate_grad_batches: Optional[int|str] = None
...
class CheckpointCallbackParamsConfig(BaseModel):
    ...
    every_n_train_steps: Optional[int|str] = None
    monitor: Optional[str] = None
    mode: Optional[str] = None
    save_last: Optional[bool] = None
    always_save_nemo: Optional[bool] = None
    save_nemo_on_train_end: Optional[bool] = None
...
class StepTimingKwargsConfig(BaseModel):
    ...
    buffer_size: Optional[int|str] = None
...
class RopeScalingConfig(BaseModel):
    ...
    original_max_position_embeddings: Optional[int|str] = None
...
class OptimizerConfig(BaseModel):
    ...
    bucket_cap_mb: Optional[int|str] = None
...
class DataConfig(BaseModel):
    ...
    seq_length: Optional[int|str] = None
    skip_warmup: Optional[bool] = None
    num_workers: Optional[int|str] = None
...
class ModelConfig(BaseModel):
    ...
    model_type: Optional[str] = None
    train_batch_size: Optional[int|str] = None
    val_batch_size: Optional[int|str] = None
    seed: Optional[int|str] = None
    grad_clip: Optional[float] = None
    log_reduced_training_loss: Optional[bool] = None

    # Additional model-specific fields found in recipes
    max_window_layers: Optional[int|str] = None
    rms_norm_eps: Optional[float] = None
    tie_word_embeddings: Optional[bool] = None
    use_sliding_window: Optional[bool] = None

    # Memory saving/distributed training configs
    tensor_model_parallel_degree: Optional[int|str] = None
    expert_model_parallel_degree: Optional[int|str] = None
    context_parallel_degree: Optional[int|str] = None
    moe: Optional[bool] = None
    sliding_window: Optional[int|str] = None
    num_experts_per_tok: Optional[int|str] = None
    num_local_experts: Optional[int|str] = None
    ...
    activation_loading_horizon: Optional[int|str] = None
    ...
    shard_degree: Optional[int|str] = None
    ...
    fp8_amax_history_len: Optional[int|str] = None
    fp8_amax_compute_algo: Optional[str] = None

    # Model architecture
    max_context_width: Optional[int|str] = None
    max_position_embeddings: Optional[int|str] = None
    num_hidden_layers: Optional[int|str] = None
    hidden_size: Optional[int|str] = None
    num_attention_heads: Optional[int|str] = None
    intermediate_size: Optional[int|str] = None
    initializer_range: Optional[float] = None
    layernorm_epsilon: Optional[float] = None
    vocab_size: Optional[int|str] = None
    num_key_value_heads: Optional[int|str] = None
    ...
    precision: Optional[str] = None
    lr_decay_iters: Optional[int|str] = None
    ...
    micro_batch_size: Optional[int|str] = None
    global_batch_size: Optional[int|str] = None
    rampup_batch_size: Optional[int|str] = None
    pipeline_model_parallel_size: Optional[int|str] = None
    virtual_pipeline_model_parallel_size: Optional[int|str] = None
    encoder_seq_length: Optional[int|str] = None
    ffn_hidden_size: Optional[int|str] = None
    num_query_groups: Optional[int|str] = None
    init_method_std: Optional[float] = None
    use_scaled_init_method: Optional[bool] = None
    kv_channels: Optional[int|str] = None
    apply_query_key_layer_scaling: Optional[bool] = None
    normalization: Optional[str] = None
    do_layer_norm_weight_decay: Optional[bool] = None
    make_vocab_size_divisible_by: Optional[int|str] = None
    ...
    native_amp_init_scale: Optional[int|str] = None
    native_amp_growth_interval: Optional[int|str] = None
    hysteresis: Optional[int|str] = None
    fp32_residual_connection: Optional[bool] = None
    fp16_lm_cross_entropy: Optional[bool] = None
    megatron_amp_O2: Optional[bool] = None
    grad_allreduce_chunk_size_mb: Optional[int|str] = None
    ...
    apex_transformer_log_level: Optional[int|str] = None
    ...
    activations_checkpoint_num_layers: Optional[int|str] = None
    num_micro_batches_with_partial_activation_checkpoints: Optional[int|str] = None
    activations_checkpoint_layers_per_pipeline: Optional[int|str] = None
    ...
    fp8_margin: Optional[int|str] = None
    fp8_interval: Optional[int|str] = None
