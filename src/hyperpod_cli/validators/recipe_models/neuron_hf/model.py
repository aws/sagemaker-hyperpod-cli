...
class TrainerConfig(BaseModel):
    ...
    val_check_interval: Optional[int|str] = None
    check_val_every_n_epoch: Optional[int|str] = None
    num_sanity_val_steps: Optional[int|str] = None
...
class DistributedStrategyConfig(BaseModel):
    ...
    tensor_model_parallel_size: Optional[int|str] = None
    ...
    kv_replicator: Optional[int|str] = None
...
class DataConfig(BaseModel):
    ...
    dev_choose_samples: Optional[int|str] = None
...
class ModelConfig(BaseModel):
    ...
    num_layers: Optional[int|str] = None
...
class NeuronHfRecipeSchema(BaseModel):
    ...
    aync_exec_max_inflight_requests: Optional[int|str] = None
    bucket_size_collectives: Optional[int|str] = None
    neuron_rt_exec_timeout: Optional[int|str] = None
