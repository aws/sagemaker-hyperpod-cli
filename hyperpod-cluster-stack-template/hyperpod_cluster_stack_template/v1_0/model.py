...
class ClusterStackBase(BaseModel):
    resource_name_prefix: Optional[str] = Field("hyp-eks-stack", description="Prefix to be used for all resources")
    ...
    helm_repo_url: Optional[str] = Field("https://github.com/aws/sagemaker-hyperpod-cli.git", description="The URL of the Helm repo containing the HyperPod Helm chart")
    helm_repo_path: Optional[str] = Field("helm_chart/HyperPodHelmChart", description="The path to the HyperPod Helm chart in the Helm repo")
    ...
    availability_zone_ids: Union[List[str], None] = Field(["use2-az1", "use2-az2", "use2-az3"], description="List of AZs to deploy subnets in. Zones must exist in submission region.")
    ...
    custom_bucket_name: Optional[str] = Field(None, description="Custom S3 bucket name for templates. If provided, will override the default bucket. Leave empty to use default.")
    ...
    fsx_availability_zone_id: Optional[str] = Field("use2-az2", description="The availability zone to get subnet id that will be used to create FSx")
